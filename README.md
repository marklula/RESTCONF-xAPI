# RESTCONF-xAPI
This repository provides examples how to use RESTCONF with HTTP GET and PATCH to modify a switch configuration running IOS XE directly from a Room OS Macro.
